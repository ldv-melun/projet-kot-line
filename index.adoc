...
Parceque les fichiers CSV sont des fichiers "texte" (par opposition aux fichierx "binaire"), il est nécessaire de savoir que ce type de fichier peut intégrer une méta-donnée, nommée `BOM` dans les tout premiers octets.
