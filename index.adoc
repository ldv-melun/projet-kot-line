...
* quelles seront les données statistiques retenues et comment comptez-vous les représenter (modèles graphiques) au gestionnaire (en retour de sa requête HTTP)
